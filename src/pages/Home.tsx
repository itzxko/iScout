...
const Home = () => {
  return (
    <>
      <NavigationBar />
      <div className="w-full min-h-[100svh] bg-[#FCFCFC] bg-cover flex items-start justify-center font-host-grotesk py-12">
        <div className="min-h-full w-full flex flex-col items-center justify-center space-y-24">
          <div className="w-full lg:w-3/6 flex flex-col items-center justify-center px-6">
            ...
            <p className="text-xs w-full lg:max-w-[40%] text-center text-[#999999]">
          ...
          <div className="w-full  flex flex-row items-center justify-center bg-[url('./assets/scout.jpg')] bg-cover bg-center h-[420px]">
