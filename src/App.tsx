...
import BOR from "./pages/scout/BOR";
import AdminApprovals from "./pages/admin/Approvals";
import LeaderUsers from "./pages/leader/Users";
import ScoutCamps from "./pages/scout/Camps";
import AdminQuizAttempt from "./pages/admin/QuizAttempt";
import { QuizAttemptProvider } from "./context/QuizAttemptProvider";
import { ReviewProvider } from "./context/ReviewProvider";
import LeaderQuizAttempt from "./pages/leader/QuizAttempt";
                    ...
                    <ReviewProvider>
                      <ReportsProvider>
                        <Routes>
                          ...
                          />
                          <Route
                            path="/admin/quiz-attempt"
                            element={<AdminQuizAttempt />}
                          />
                          <Route
                          ...
                          <Route
                            path="/scout/account"
                            element={<ScoutAccount />}
                          />
                          <Route path="/scout/bor" element={<BOR />} />
                          ...
                          />
                          <Route
                            path="/scout/exam/eagle"
                            element={<EagleExam />}
                          />
                          <Route path="/scout/camps" element={<ScoutCamps />} />

                          {/* leader */}
                          <Route
                            path="/leader/account"
                            element={<LeaderAccount />}
                          />
